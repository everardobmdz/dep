...
@section('title', 'Editar Sobre el DEP')
                    ...
                    <form action="{{ route('admin.proyectos-actuales.store') }}" method="post" enctype="multipart/form-data" class="col-12">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <textarea type="text" class="form-control" id="contenido" name="contenido" value="{{ $sobre_el_dep->contenido }}">{{ $sobre_el_dep->contenido }}</textarea>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-control" id="investigador_id" name="investigador_id">
                                    ...
                                    @foreach ($investigadores as $investigador)
                                        @if ($sobre_el_dep->investigador->id == $investigador->id)
