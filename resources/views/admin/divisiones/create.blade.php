...
<div class="card ">
    <div class="card-body">
        @if (Auth::check() && Auth::user()->rol == 'admin')
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('admin.divisiones.store') }}" method="post" enctype="multipart/form-data" class="col-12">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                ...
                                <input autocomplete="off" type="text" class="date-own form-control" id="url" name="url" value="{{ old('url') }}">
                            </div>
                        </div>
                        <br>
                        <div class="row align-items-center">
